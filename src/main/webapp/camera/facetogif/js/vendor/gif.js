(function (c) {
    ...
    a.define('/gif.coffee', function (b, k, j, i) {
        ...
        d = a('events', b).EventEmitter, e = a('/browser.coffee', b), f = function (f, b, d) {
            ...
            return h(a, f), b = {
            ...
            }, a.prototype.addFrame = function (b, c) {
                var a, e;
                null == c && (c = {}), a = {};
                for (e in d) a[e] = c[e] || d[e];
                if ('undefined' !== typeof ImageData && null != ImageData && b instanceof ImageData) a.data = b.data, a.width = a.witdh || b.width, a.height = a.height || b.height;
                else if ('undefined' !== typeof CanvasRenderingContext2D && null != CanvasRenderingContext2D && b instanceof CanvasRenderingContext2D || 'undefined' !== typeof WebGLRenderingContext && null != WebGLRenderingContext && b instanceof WebGLRenderingContext) c.copy ? a.data = this.getContextData(b) : a.context = b;
                else if (null != b.childNodes) null != this.options.width || this.setOption('width', b.width), null != this.options.height || this.setOption('height', b.height), c.copy ? a.data = this.getImageData(b) : a.image = b;
                else throw new Error('Invalid image');
                return this.frames.push(a), null != a.width && this.setOption('width', a.width), null != a.height ? this.setOption('height', a.height) : void 0
            }, a.prototype.render = function () {
                var d, a;
                if (this.running) throw new Error('Already running');
                this.running = !0, this.nextFrame = 0, this.finishedFrames = 0, this.imageParts = function (b) {
                    var d;
                    for (var a = 0, c = function () {
                            ...
                            return b
                        }.apply(this, arguments).length; a < c; ++a) d = function () {
                        var b, b;
                        b = [];
                        for (var a = 0; 0 <= this.frames.length ? a < this.frames.length : a > this.frames.length; 0 <= this.frames.length ? ++a : --a) b.push(a);
                        return b
                    }.apply(this, arguments)[a], b.push(null);
                    return b
                ...
                for (var b = 0, c = function () {
                        ...
                        return c
                    }.apply(this, arguments).length; b < c; ++b) d = function () {
                    var c, c;
                    c = [];
                    for (var b = 0; 0 <= a ? b < a : b > a; 0 <= a ? ++b : --b) c.push(b);
                    return c
                }.apply(this, arguments)[b], this.renderNextFrame();
                ...
                for (var c = 0, d = function () {
                        ...
                        return c
                    }.apply(this, arguments).length; c < d; ++c) e = function () {
                    var c, c;
                    c = [];
                    for (var b = this.freeWorkers.length; this.freeWorkers.length <= a ? b < a : b > a; this.freeWorkers.length <= a ? ++b : --b) c.push(b);
                    return c
                }.apply(this, arguments)[c], (b = this, function (d) {
                    var a, c;
                    return console.log('spawning worker ' + d), c = new Worker(b.options.workerScript), a = b, c.onmessage = function (b) {
                        return a.activeWorkers.splice(a.activeWorkers.indexOf(c), 1), a.freeWorkers.push(c), a.frameFinished(b.data)
                    }, b.freeWorkers.push(c)
                })();
                return a
...
*/
// gif.js 0.1.2 - https://github.com/jnordberg/gif.js